using AutoMapper;
using AuthServerServices.Catalog.Dtos;
using AuthServerServices.Catalog.Models;
using AuthServerServices.Catalog.Settings;
using AuthServerShared.Dtos;
...
using AuthServerShared.Messages;

namespace AuthServerServices.Catalog.Services
{
